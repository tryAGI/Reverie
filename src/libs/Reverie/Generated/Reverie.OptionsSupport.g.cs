...
namespace Reverie
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Reverie.AutoSDKRetryOptions Retry { get; set; } = new global::Reverie.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Reverie.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Reverie.IAutoSDKHook>();
        ...
        public global::Reverie.AutoSDKClientOptions AddHook(
            global::Reverie.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Reverie.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Reverie.AutoSDKClientOptions UseAuthorizationProvider(
            global::Reverie.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Reverie.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Reverie.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Reverie.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Reverie.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Reverie.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Reverie.AutoSDKHook
    {
        /// <inheritdoc />
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Reverie.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Reverie.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Reverie.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Reverie.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Reverie.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Reverie.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Reverie.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Reverie.AutoSDKClientOptions clientOptions,
            global::Reverie.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Reverie.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Reverie.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Reverie.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Reverie.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Reverie.IAutoSDKHook, global::Reverie.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Reverie.AutoSDKHookContext context)
        {
