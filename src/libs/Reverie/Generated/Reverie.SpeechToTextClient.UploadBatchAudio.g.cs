...
namespace Reverie
{
    public partial class SpeechToTextClient
    {
        ...
        private static readonly global::Reverie.EndPointSecurityRequirement s_UploadBatchAudioSecurityRequirement0 =
        ...
        private static readonly global::Reverie.EndPointSecurityRequirement[] s_UploadBatchAudioSecurityRequirements =
            new global::Reverie.EndPointSecurityRequirement[]
            {                s_UploadBatchAudioSecurityRequirement0,
            };
        partial void PrepareUploadBatchAudioArguments(
        ...
        partial void PrepareUploadBatchAudioRequest(
            ...
            string? domain,
            global::Reverie.TranscribeFileRequest request);
        partial void ProcessUploadBatchAudioResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUploadBatchAudioResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reverie.BatchUploadResponse> UploadBatchAudioAsync(
            string srcLang,
        ...
        {
            var __response = await UploadBatchAudioAsResponseAsync(
                srcLang: srcLang,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reverie.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reverie.AutoSDKHttpResponse<global::Reverie.BatchUploadResponse>> UploadBatchAudioAsResponseAsync(
            string srcLang,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUploadBatchAudioArguments(
            ...
            var __authorizations = global::Reverie.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UploadBatchAudioSecurityRequirements,
                operationName: "UploadBatchAudioAsync");
            ...
            if (domain != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUploadBatchAudioRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reverie.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reverie.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UploadBatchAudio",
                                methodName: "UploadBatchAudioAsync",
                                pathTemplate: "\"/upload\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUploadBatchAudioResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reverie.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUploadBatchAudioResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reverie.BatchUploadResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reverie.AutoSDKHttpResponse<global::Reverie.BatchUploadResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reverie.BatchUploadResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await UploadBatchAudioAsync(
                srcLang: srcLang,
                domain: domain,
                request: __request,
                requestOptions: requestOptions,
                    ...
                    await global::Reverie.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Reverie.BatchUploadResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Reverie.BatchUploadResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
