...
namespace Reverie
{
    public partial class TextToSpeechClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reverie.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> TextToSpeechAsStreamAsync(
            string speaker,
                ...
                else
                {
                    await global::Reverie.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            try
                            {
                                ...
                                return new global::Reverie.ResponseStream(__response, __content);
                            }
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reverie.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reverie.AutoSDKHttpResponse<byte[]>> TextToSpeechAsResponseAsync(
            string speaker,
                    ...
                    await global::Reverie.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Reverie.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
