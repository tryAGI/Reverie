...
namespace Reverie
{
    public partial class SpeechToTextClient
    {
        ...
        private static readonly global::Reverie.EndPointSecurityRequirement s_GetBatchTranscriptSecurityRequirement0 =
        ...
        private static readonly global::Reverie.EndPointSecurityRequirement[] s_GetBatchTranscriptSecurityRequirements =
            new global::Reverie.EndPointSecurityRequirement[]
            {                s_GetBatchTranscriptSecurityRequirement0,
            };
        partial void PrepareGetBatchTranscriptArguments(
        ...
        partial void PrepareGetBatchTranscriptRequest(
            ...
            string jobId);
        partial void ProcessGetBatchTranscriptResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetBatchTranscriptResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Reverie.BatchTranscriptResponse> GetBatchTranscriptAsync(
            string jobId,
            global::Reverie.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetBatchTranscriptAsResponseAsync(
                jobId: jobId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Reverie.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Reverie.AutoSDKHttpResponse<global::Reverie.BatchTranscriptResponse>> GetBatchTranscriptAsResponseAsync(
            string jobId,
            global::Reverie.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetBatchTranscriptArguments(
            ...
            var __authorizations = global::Reverie.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetBatchTranscriptSecurityRequirements,
                operationName: "GetBatchTranscriptAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Reverie.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Reverie.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetBatchTranscript",
                                methodName: "GetBatchTranscriptAsync",
                                pathTemplate: "$\"/transcript?job_id={jobId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetBatchTranscriptResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Reverie.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetBatchTranscriptResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Reverie.BatchTranscriptResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Reverie.AutoSDKHttpResponse<global::Reverie.BatchTranscriptResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Reverie.BatchTranscriptResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
